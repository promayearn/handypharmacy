...
public class HomePharmacyActivity extends Activity implements View.OnClickListener {

    private static final String TAG = "HomePharmActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_pharm);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.chatbtn:
                ...
                break;
            case R.id.mapbtn:
                startActivity(new Intent(v.getContext(), RegisterDrugStoreActivity.class));
                break;
